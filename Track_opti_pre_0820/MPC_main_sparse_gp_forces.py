...
def MPCmain_forces(iteration, file_iter = None, gp_train = False, map_dir = './MAP', file_dir='/GP/', file_name = 'optimized_traj', return_ = False, plot_ = False, label = None, model_param = None, failure = False):
    ...
    x0[0], x0[1], x0[2], x0[3] = 0.0, track.ey[0], track.epsi[0], track.v[0]
    u_mpc = np.array([0,0])
...
# traj, _, _, lap_time,col = MPCmain_forces(-1, gp_train=False,  file_name = 'optimized_traj', map_dir = f"./MAP0",  file_dir='/GP/', return_ = True, plot_ = True, label =  f'MAP{0}_DynGP')
