...
def MPCmain_bruteforces(iteration,B,C,Wheelfriction,Iz, file_iter = None, gp_train = False, map_dir = './MAP', file_dir='/GP/', file_name = 'optimized_traj', return_ = False, plot_ = False, label = None, model_param = None, failure = False):
    ...
    if gp_train:
        ...
        # print(dynamics.C,dynamics.wheel_friction,dynamics.Iz,dynamics.B)
        dynamics.wheel_friction = Wheelfriction
        dynamics.C = C
        dynamics.B = B
        dynamics.Iz = Iz
...
# traj, _, _, lap_time,col = MPCmain_bruteforces(1,1,1.1,0.7,0.02025, gp_train=True,  file_name = 'optimized_traj', map_dir = f"./MAP0",  file_dir='/GP/', return_ = True, plot_ = True, label =  f'MAP{0}_DynGP')
