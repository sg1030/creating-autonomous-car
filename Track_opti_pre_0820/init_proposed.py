...
def SolveMinimumLapTime(dir, model, iter, model_param = None):
    ...
    if model == 'DynTrue':
        ...
        np.savetxt(f'{dir}/Traj/optimized_traj_brute0.txt', trackoptimization.opt_traj, delimiter=",")
        np.savetxt(f'{dir}/Traj/optimized_traj_brute0_frenet.txt', trackoptimization.opt_traj_fren, delimiter=",")
    print('saved')
