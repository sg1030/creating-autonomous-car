...
from bf_torch_sparse_double import trainMain_sparse_torch
...
for i in range(1,10):
    ...
    dyn = {
            ...
            "Iz": Iz,
            "wheel_friction": mu}
    plannedtime = SolveMinimumLapTime('./MAP0','DynGP',i, dyn)
    traj, _, _, lap_time,col = MPCmain_bruteforces(i,B,C,mu,Iz, gp_train=True,  file_name = 'optimized_gp_traj', map_dir = f"./MAP0",  file_dir='/GP/', return_ = True, plot_ = False, label =  f'MAP{0}_DynGP')
    lap_time_list_gp.append(lap_time)
    print(grid_division)
print(lap_time_list_gp)
print(planned_time_list)
import numpy as np
