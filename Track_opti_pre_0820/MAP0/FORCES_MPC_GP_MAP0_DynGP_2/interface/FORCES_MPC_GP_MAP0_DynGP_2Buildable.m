...
% 
classdef FORCES_MPC_GP_MAP0_DynGP_2Buildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, cfg)
            ...
            if(~strcmp(foldername, 'interface') || ~strcmp(solvername, 'FORCES_MPC_GP_MAP0_DynGP_2'))
                solverpath = fullfile(buildablepath, 'FORCES_MPC_GP_MAP0_DynGP_2');
            end
            solverInfo = struct();
            solverInfo.solvername = 'FORCES_MPC_GP_MAP0_DynGP_2';
        ...
        function [output,exitflag,info] = forcesCallWithParams(params)
            [output,exitflag,info] = FORCES_MPC_GP_MAP0_DynGP_2Buildable.forcesCall(params.xinit, params.x0, params.all_parameters);
        end

        function [output, exitflag, info] = forcesCall(xinit, x0, all_parameters)
            solvername = 'FORCES_MPC_GP_MAP0_DynGP_2';
            ...
            [output_c, exitflag_c, info_c] = FORCES_MPC_GP_MAP0_DynGP_2Buildable.forcesInitOutputsC(); %#ok<ASGLU>
            ...
            [output, exitflag, info] = FORCES_MPC_GP_MAP0_DynGP_2Buildable.forcesInitOutputsMatlab();
