 ...
 *  - FORCES_MPC_GP_MAP0_DynGP_4
 *  - "include/FORCES_MPC_GP_MAP0_DynGP_4.h"
 *  - FORCES_MPC_GP_MAP0_DynGP_4_adtool2forces
 *  - FORCES_MPC_GP_MAP0_DynGP_4_interface
 *
...
#define SOLVER_FLOAT CONCATENATE(FORCES_MPC_GP_MAP0_DynGP_4, _float)
#define SOLVER_FUN_NAME CONCATENATE(FORCES_MPC_GP_MAP0_DynGP_4, _solve)

#include "include/FORCES_MPC_GP_MAP0_DynGP_4.h"

/* Header of external evaluation function */
solver_int32_default FORCES_MPC_GP_MAP0_DynGP_4_adtool2forces(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int FORCES_MPC_GP_MAP0_DynGP_4_interface(void *params, void *outputs, void *info, void *mem, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, mem, fp, &FORCES_MPC_GP_MAP0_DynGP_4_adtool2forces);
}
