...
sourcedir = os.path.join(os.getcwd(), "FORCES_MPC_GP_MAP0_DynGP_9", "src")
sourcefile_list = glob.glob(os.path.join(sourcedir, "*.c"))

# determine lib file
libdir = os.path.join(os.getcwd(), "FORCES_MPC_GP_MAP0_DynGP_9", "lib")
lib_opts = []
if sys.platform.startswith('win'):
	static_libformat = "FORCES_MPC_GP_MAP0_DynGP_9_static"
	shared_libformat = "FORCES_MPC_GP_MAP0_DynGP_9"
	lib_opts.append("/DLL")
else:
	static_libformat = "FORCES_MPC_GP_MAP0_DynGP_9"
	shared_libformat = "FORCES_MPC_GP_MAP0_DynGP_9"
...
objdir = os.path.join(os.getcwd(),"FORCES_MPC_GP_MAP0_DynGP_9","obj")
...
# create libraries
exportsymbols = ["FORCES_MPC_GP_MAP0_DynGP_9_solve", "FORCES_MPC_GP_MAP0_DynGP_9_internal_mem"]
try:
	os.chdir(objdir)
