 ...
 *  - FORCES_MPC_GP_MAP0_DynGP_1
 *  - "include/FORCES_MPC_GP_MAP0_DynGP_1.h"
 *  - FORCES_MPC_GP_MAP0_DynGP_1_adtool2forces
 *  - FORCES_MPC_GP_MAP0_DynGP_1_interface
 *
...
#define SOLVER_FLOAT CONCATENATE(FORCES_MPC_GP_MAP0_DynGP_1, _float)
#define SOLVER_FUN_NAME CONCATENATE(FORCES_MPC_GP_MAP0_DynGP_1, _solve)

#include "include/FORCES_MPC_GP_MAP0_DynGP_1.h"

/* Header of external evaluation function */
solver_int32_default FORCES_MPC_GP_MAP0_DynGP_1_adtool2forces(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int FORCES_MPC_GP_MAP0_DynGP_1_interface(void *params, void *outputs, void *info, void *mem, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, mem, fp, &FORCES_MPC_GP_MAP0_DynGP_1_adtool2forces);
}
