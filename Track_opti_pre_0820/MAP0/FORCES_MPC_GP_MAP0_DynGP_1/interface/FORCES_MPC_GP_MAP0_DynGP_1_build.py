...
sourcedir = os.path.join(os.getcwd(), "FORCES_MPC_GP_MAP0_DynGP_1", "src")
sourcefile_list = glob.glob(os.path.join(sourcedir, "*.c"))

# determine lib file
libdir = os.path.join(os.getcwd(), "FORCES_MPC_GP_MAP0_DynGP_1", "lib")
lib_opts = []
if sys.platform.startswith('win'):
	static_libformat = "FORCES_MPC_GP_MAP0_DynGP_1_static"
	shared_libformat = "FORCES_MPC_GP_MAP0_DynGP_1"
	lib_opts.append("/DLL")
else:
	static_libformat = "FORCES_MPC_GP_MAP0_DynGP_1"
	shared_libformat = "FORCES_MPC_GP_MAP0_DynGP_1"
...
objdir = os.path.join(os.getcwd(),"FORCES_MPC_GP_MAP0_DynGP_1","obj")
...
# create libraries
exportsymbols = ["FORCES_MPC_GP_MAP0_DynGP_1_solve", "FORCES_MPC_GP_MAP0_DynGP_1_internal_mem"]
try:
	os.chdir(objdir)
