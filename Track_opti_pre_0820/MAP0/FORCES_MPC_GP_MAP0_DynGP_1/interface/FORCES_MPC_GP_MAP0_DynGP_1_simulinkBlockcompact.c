...
#define S_FUNCTION_NAME FORCES_MPC_GP_MAP0_DynGP_1_simulinkBlockcompact
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call solver */
    solver_exitflag = FORCES_MPC_GP_MAP0_DynGP_1_solve(&params, &output, &info, mem, fp , pt2function_FORCES_MPC_GP_MAP0_DynGP_1);
