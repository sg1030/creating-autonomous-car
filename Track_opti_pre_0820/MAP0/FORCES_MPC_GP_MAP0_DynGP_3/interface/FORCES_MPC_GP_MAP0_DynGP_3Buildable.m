...
% 
classdef FORCES_MPC_GP_MAP0_DynGP_3Buildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, cfg)
            ...
            if(~strcmp(foldername, 'interface') || ~strcmp(solvername, 'FORCES_MPC_GP_MAP0_DynGP_3'))
                solverpath = fullfile(buildablepath, 'FORCES_MPC_GP_MAP0_DynGP_3');
            end
            solverInfo = struct();
            solverInfo.solvername = 'FORCES_MPC_GP_MAP0_DynGP_3';
        ...
        function [output,exitflag,info] = forcesCallWithParams(params)
            [output,exitflag,info] = FORCES_MPC_GP_MAP0_DynGP_3Buildable.forcesCall(params.xinit, params.x0, params.all_parameters);
        end

        function [output, exitflag, info] = forcesCall(xinit, x0, all_parameters)
            solvername = 'FORCES_MPC_GP_MAP0_DynGP_3';
            ...
            [output_c, exitflag_c, info_c] = FORCES_MPC_GP_MAP0_DynGP_3Buildable.forcesInitOutputsC(); %#ok<ASGLU>
            ...
            [output, exitflag, info] = FORCES_MPC_GP_MAP0_DynGP_3Buildable.forcesInitOutputsMatlab();
