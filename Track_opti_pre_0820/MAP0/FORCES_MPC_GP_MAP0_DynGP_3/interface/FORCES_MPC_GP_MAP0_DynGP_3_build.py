...
sourcedir = os.path.join(os.getcwd(), "FORCES_MPC_GP_MAP0_DynGP_3", "src")
sourcefile_list = glob.glob(os.path.join(sourcedir, "*.c"))

# determine lib file
libdir = os.path.join(os.getcwd(), "FORCES_MPC_GP_MAP0_DynGP_3", "lib")
lib_opts = []
if sys.platform.startswith('win'):
	static_libformat = "FORCES_MPC_GP_MAP0_DynGP_3_static"
	shared_libformat = "FORCES_MPC_GP_MAP0_DynGP_3"
	lib_opts.append("/DLL")
else:
	static_libformat = "FORCES_MPC_GP_MAP0_DynGP_3"
	shared_libformat = "FORCES_MPC_GP_MAP0_DynGP_3"
...
objdir = os.path.join(os.getcwd(),"FORCES_MPC_GP_MAP0_DynGP_3","obj")
...
# create libraries
exportsymbols = ["FORCES_MPC_GP_MAP0_DynGP_3_solve", "FORCES_MPC_GP_MAP0_DynGP_3_internal_mem"]
try:
	os.chdir(objdir)
