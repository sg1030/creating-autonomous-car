...
sourcedir = os.path.join(os.getcwd(), "FORCES_MPC_GP_MAP0_DynGP_8", "src")
sourcefile_list = glob.glob(os.path.join(sourcedir, "*.c"))

# determine lib file
libdir = os.path.join(os.getcwd(), "FORCES_MPC_GP_MAP0_DynGP_8", "lib")
lib_opts = []
if sys.platform.startswith('win'):
	static_libformat = "FORCES_MPC_GP_MAP0_DynGP_8_static"
	shared_libformat = "FORCES_MPC_GP_MAP0_DynGP_8"
	lib_opts.append("/DLL")
else:
	static_libformat = "FORCES_MPC_GP_MAP0_DynGP_8"
	shared_libformat = "FORCES_MPC_GP_MAP0_DynGP_8"
...
objdir = os.path.join(os.getcwd(),"FORCES_MPC_GP_MAP0_DynGP_8","obj")
...
# create libraries
exportsymbols = ["FORCES_MPC_GP_MAP0_DynGP_8_solve", "FORCES_MPC_GP_MAP0_DynGP_8_internal_mem"]
try:
	os.chdir(objdir)
