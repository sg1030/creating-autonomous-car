...
lap_time_list_gp=[]
SolveMinimumLapTime('./MAP0','Dyn',0)
traj, _, _, lap_time,col = MPCmain_forces(0, gp_train=False,  file_name = 'optimized_traj_brute', map_dir = f"./MAP0",  file_dir='/GP/', return_ = True, plot_ = False, label =  f'MAP{0}_DynGP')
lap_time0=lap_time
B_prev=0
C_prev=0
mu_prev=0
...
for i in range(1,10):
    if i==1:
        ...
        if grid_division==0:
            B,C,mu,Iz,_,_=runMain_bruteforce_id(
                ...
                file_dir="./MAP0/GP",
                map_dir="MAP0",
                file_name="optimized_traj_brute",
                track_idx=0,
                traj_type="opt_traj",
                dt=0.1,
                N=15,
    ...
    dyn = {
            ...
            "Iz": Iz,
            "wheel_friction": mu}
    SolveMinimumLapTime('./MAP0','Dyn',0,dyn)
    traj, _, _, lap_time,col = MPCmain_bruteforces(0,B,C,mu,Iz, gp_train=False,  file_name = 'optimized_traj_brute', map_dir = f"./MAP0",  file_dir='/GP/', return_ = True, plot_ = False, label =  f'MAP{0}_DynGP')
